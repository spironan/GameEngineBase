				...
				for (auto& iter = s_messageCollection.begin(); iter != s_messageCollection.end(); ++iter,++counter)
				{
					if (counter >= clipper.DisplayStart)
					{
						...
						case 0://trace
							...
							ImGui::Image(engine::AssetManager::GetNamedAsset<engine::Texture>("Ouroboros_Log_Icon_Black")->Get_IMTEXTURE_ID(), { imageSize,imageSize });
							break;
						case 1://debug
						...
						case 3://warn
						{
							...
							ImGui::Image(engine::AssetManager::GetNamedAsset<engine::Texture>("Ouroboros_Warning_Icon_Yellow")->Get_IMTEXTURE_ID(), { imageSize,imageSize });
						}break;
						case 4://err
							ImGui::PushStyleColor(ImGuiCol_Text, { 0.5f,0,0,1 }); 
							ImGui::Image(engine::AssetManager::GetNamedAsset<engine::Texture>("Ouroboros_Error_Icon_Red")->Get_IMTEXTURE_ID(), { imageSize,imageSize });
							break;
						case 5://critical
