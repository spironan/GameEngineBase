...
bool vkutil::load_image_from_file(VulkanEngine &engine, const char *file, AllocatedImage &outImage)
{
    ...
    //allocate temporary buffer for holding texture data
    ...
    vmaCreateImage(engine._allocator, &dimg_info, &dimg_alloc_info, &newImage._image, &newImage._allocation, nullptr);
