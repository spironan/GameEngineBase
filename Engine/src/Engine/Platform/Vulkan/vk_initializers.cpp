...
VkPipelineInputAssemblyStateCreateInfo vkinit::input_assembly_create_info(VkPrimitiveTopology topology)
{
	...
	// we are not going to use primiative restart on the entire tutorial so leave it on false
...
VkPipelineRasterizationStateCreateInfo vkinit::rasterization_state_create_info(VkPolygonMode polygonMode)
{
	...
	// discards all primatives before the rasterization stage if enabled which we dont want
...
VkPipelineMultisampleStateCreateInfo vkinit::multisampling_state_create_info()
{
	...
	// multisampling disabled by default to no multisampling (1 sample per pixel)
